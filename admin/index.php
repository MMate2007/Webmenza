...
$autochoice = $mysql->query("SELECT COUNT(`autochoice`) FROM `users`")->fetch_row()[0];
echo $twig->render("adminhome.html.twig", ["nonreg" => $nonreg, "allreg" => $allreg, "passkeys" => $passkeys, "notis" => $notis, "autochoice" => $autochoice]);
?>