...
if (isset($_FILES["spreadsheet"])) {
    ...
    try {
    $stmt = $mysql->prepare("INSERT INTO `menu`(`date`, `mealId`, `id`, `description`) VALUES (?,?,?,?)");
    $stmt->bind_param("siis", $date, $_POST["meal"], $id, $description);
    foreach ($rowGenerator as $row) {
...
echo $twig->render("import.menu.html.twig", ["meals" => $meals]);
?>